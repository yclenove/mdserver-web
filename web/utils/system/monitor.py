...
class monitor:
    ...
    def run(self):
        ...
        network_objm.add(
            "up,down,total_up,total_down,down_packets,up_packets,addtime", netio_data
        )
        ...
        load_objm.add(
            ...
            (lpro, load_data["one"], load_data["five"], load_data["fifteen"], addtime),
        )
