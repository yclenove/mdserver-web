...
blueprint = Blueprint(
    "firewall", __name__, url_prefix="/firewall", template_folder="../../templates"
)
...
@blueprint.route(
    "/set_ssh_root_status", endpoint="set_ssh_root_status", methods=["POST"]
)
@panel_login_required
...
@blueprint.route(
    "/set_ssh_pass_status", endpoint="set_ssh_pass_status", methods=["POST"]
)
@panel_login_required
...
@blueprint.route(
    "/set_ssh_pubkey_status", endpoint="set_ssh_pubkey_status", methods=["POST"]
)
@panel_login_required
