...
def get_notify_tgbot():
    notify_tgbot = thisdb.getOptionByJson(
...
# 设置邮件测试
@blueprint.route(
    "/set_notify_tgbot_test", endpoint="set_notify_tgbot_test", methods=["POST"]
)
@panel_login_required
...
# 切换邮件开关
@blueprint.route(
    "/set_notify_tgbot_enable", endpoint="set_notify_tgbot_enable", methods=["POST"]
)
@panel_login_required
