...
def get_notify_email():
    notify_email = thisdb.getOptionByJson(
...
# 设置邮件测试
@blueprint.route(
    "/set_notify_email_test", endpoint="set_notify_email_test", methods=["POST"]
)
@panel_login_required
...
# 切换邮件开关
@blueprint.route(
    "/set_notify_email_enable", endpoint="set_notify_email_enable", methods=["POST"]
)
@panel_login_required
